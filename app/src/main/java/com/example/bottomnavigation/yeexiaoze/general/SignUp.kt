...
import com.example.bottomnavigation.yeexiaoze.database.user.UserModel
import com.example.bottomnavigation.yeexiaoze.database.user.UserSQLiteHelper
import com.example.bottomnavigation.databinding.SignUpBinding
...
class SignUp : AppCompatActivity() {
    ...
    private fun alertDialog() {
        ...
        alert.setMessage("Your account has been successfully registered. Kindly navigate to the login page to login.")
